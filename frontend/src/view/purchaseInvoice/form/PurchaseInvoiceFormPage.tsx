...
import actions from 'src/modules/purchaseInvoice/form/purchaseInvoiceFormActions';
import selectors from 'src/modules/purchaseInvoice/form/purchaseInvoiceFormSelectors';
...
function PurchaseInvoiceFormPage(props) {
      ...
      <ContentWrapper>
        ...
        {dispatched && !initLoading && (
          <PurchaseInvoiceForm
            ...
            isEditing={isEditing}
            onSubmit={doSubmit}
            onCancel={() => getHistory().push('/purchase-invoice')}
          />
        )}
      </ContentWrapper>
    </>
