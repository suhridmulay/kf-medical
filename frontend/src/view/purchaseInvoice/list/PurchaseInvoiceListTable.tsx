...
function PurchaseInvoiceListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    purchaseInvoiceSelectors.selectPermissionToEdit,
  );
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                label={i18n(
                  'entities.purchaseInvoice.fields.purchaseOrder',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                      ...
                      {hasPermissionToEdit && (
                        ...
                        >
                          <IconButton
                            color="primary"
                            component={Link}
                            to={`/purchase-invoice/${row.id}/edit`}
                          >
                            <EditIcon />
                          </IconButton>
                        </Tooltip>
