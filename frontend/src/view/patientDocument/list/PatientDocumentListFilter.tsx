...
const previewRenders = {
  ...
  reportDateRange: {
    label: i18n('entities.patientDocument.fields.reportDateRange'),
    render: filterRenders.dateRange(),
  },
}

function PatientDocumentListFilter(props) {
...
export default PatientDocumentListFilter;