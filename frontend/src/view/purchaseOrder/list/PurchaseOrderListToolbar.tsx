...
function PurchaseOrderToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    purchaseOrderSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    purchaseOrderSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=purchaseOrder"
