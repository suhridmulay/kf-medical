...
function MedicineEnumToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    medicineEnumSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    medicineEnumSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=medicineEnum"
...
export default MedicineEnumToolbar;
