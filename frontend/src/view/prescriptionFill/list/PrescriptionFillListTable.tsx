...
function PrescriptionFillListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    prescriptionFillSelectors.selectPermissionToEdit,
  );
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                label={i18n(
                  'entities.prescriptionFill.fields.patientVisit',
                )}
              />
              <TableCellCustom
                label={i18n(
                      ...
                      {hasPermissionToEdit && (
                        ...
                        >
                          <IconButton
                            color="primary"
                            component={Link}
                            to={`/prescription-fill/${row.id}/edit`}
                          >
                            <EditIcon />
                          </IconButton>
                        </Tooltip>
...
export default PrescriptionFillListTable;
