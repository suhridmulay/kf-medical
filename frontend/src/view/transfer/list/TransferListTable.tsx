        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                label={i18n(
                  'entities.transfer.fields.fromCenter',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.transfer.fields.toCenter',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.transfer.fields.medicineBatch',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
          ...
          <TableBody>
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>
                  <HealthCenterListItem value={row.fromCenter} />
                </TableCell>
                <TableCell>
                  <HealthCenterListItem value={row.toCenter} />
                </TableCell>
                <TableCell>
