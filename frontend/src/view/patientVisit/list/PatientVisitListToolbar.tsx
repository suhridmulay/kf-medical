...
function PatientVisitToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    patientVisitSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    patientVisitSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=patientVisit"
...
export default PatientVisitToolbar;
