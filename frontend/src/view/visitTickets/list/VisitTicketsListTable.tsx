...
function VisitTicketsListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    visitTicketsSelectors.selectPermissionToEdit,
  );
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                label={i18n(
                  'entities.visitTickets.fields.patientVisit',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'department'}
                label={i18n(
                  'entities.visitTickets.fields.department',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'ticketCount'}
                label={i18n(
                  'entities.visitTickets.fields.ticketCount',
                )}
                align="right"
              />              
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>
                  {row.department
                    ? i18n(
                        `entities.visitTickets.enumerators.department.${row.department}`,
                      )
                    : null}
                </TableCell>
...
export default VisitTicketsListTable;
