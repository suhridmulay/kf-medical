...
function SiteInventoryListTable(props) {
  const [
    recordIdToDestroy,
          ...
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                ...
                label={i18n(
                  'entities.siteInventory.fields.siteBatchIdentifier',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.siteInventory.fields.center',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.siteInventory.fields.batchNumber',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.siteInventory.fields.medicine',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
          ...
          <TableBody>
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>{row.siteBatchIdentifier}</TableCell>
                <TableCell>
                  <HealthCenterListItem value={row.center} />
                </TableCell>
                <TableCell>
                  <MedicineBatchListItem value={row.batchNumber} />
                </TableCell>
                <TableCell>
...
export default SiteInventoryListTable;
