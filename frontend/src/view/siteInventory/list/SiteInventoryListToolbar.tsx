...
function SiteInventoryToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    siteInventorySelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    siteInventorySelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=siteInventory"
...
export default SiteInventoryToolbar;
