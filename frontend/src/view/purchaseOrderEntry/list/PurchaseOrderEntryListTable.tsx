...
import PurchaseOrderListItem from 'src/view/purchaseOrder/list/PurchaseOrderListItem';
import MedicineEnumListItem from 'src/view/medicineEnum/list/MedicineEnumListItem';

function PurchaseOrderEntryListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    purchaseOrderEntrySelectors.selectPermissionToEdit,
  );
          ...
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                ...
                name={'totalCost'}
                label={i18n(
                  'entities.purchaseOrderEntry.fields.totalCost',
                )}
                align="right"
              />
              <TableCellCustom
                    ...
                    >
                      <Tooltip title={i18n('common.view')}>
                        <IconButton
                          component={Link}
                          color="primary"
                          to={`/purchase-order-entry/${row.id}`}
                        >
                          <SearchIcon />
                        </IconButton>
                      </Tooltip>
                      {hasPermissionToEdit && (
                        ...
                        >
                          <IconButton
                            color="primary"
                            component={Link}
                            to={`/purchase-order-entry/${row.id}/edit`}
                          >
                            <EditIcon />
                          </IconButton>
                        </Tooltip>
...
export default PurchaseOrderEntryListTable;
