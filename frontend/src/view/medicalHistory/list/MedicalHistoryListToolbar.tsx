...
function MedicalHistoryToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    medicalHistorySelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    medicalHistorySelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=medicalHistory"
...
export default MedicalHistoryToolbar;
