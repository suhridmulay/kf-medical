...
import 'visit_form_VM.dart';

class VisitFormView extends StatelessWidget {
  PatientVisit? visit;
  Patient? patient;
  final formKey = GlobalKey<FormBuilderState>();
  VisitFormView({Key? key, this.visit, this.patient}) : super(key: key);

  final _prefetchService = locator<PrefetchService>();

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<VisitFormViewModel>.reactive(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FormBuilderSlider(
                        ...
                        max: 105.0,
                        initialValue:
                            num.tryParse(visit?.temperature ?? "98.6")!
                                .toDouble(),
                        name: 'temperature',
      ...
      viewModelBuilder: () => VisitFormViewModel(),
    );
  }
}
