...
class VisitBox extends StatelessWidget {
  PatientVisit visit;
  VisitBox({Key? key, required this.visit}) : super(key: key);
          ...
          children: [
            ...
            Table(children: [
              if (visit.doctor != null)
                TableRow(
                    children: [const Text("Doctor"), Text(visit.doctor.name)]),
              ...
              if (visit.symptom1 != null ||
                ...
                TableRow(children: [
                  const Text("Symptoms"),
                  Text(
                      "${visit.symptom1 != null ? visit.symptom1.symptomName : ""} ${visit.symptom1 != null ? visit.symptom1.symptomName : ""} ${visit.symptom1 != null ? visit.symptom1.symptomName : ""}")
                ]),
              ...
              if (visit.height != null)
                TableRow(children: [const Text("Height"), Text(visit.height)]),
              if (visit.weight != null)
                TableRow(children: [const Text("Weight"), Text(visit.weight)]),
              ...
              if (visit.diagnosis != null)
                TableRow(
                    children: [const Text("Diagnosis"), Text(visit.diagnosis)]),
