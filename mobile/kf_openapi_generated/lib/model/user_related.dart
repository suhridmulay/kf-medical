...
class UserRelated {
  /// Returns a new [UserRelated] instance.
  UserRelated({
    this.fullName,
    this.firstName,
    this.emailVerified,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UserRelated &&
  ...
  @override
  String toString() => 'UserRelated[fullName=$fullName, firstName=$firstName, emailVerified=$emailVerified, emailVerificationTokenExpiresAt=$emailVerificationTokenExpiresAt, provider=$provider, providerId=$providerId, passwordResetTokenExpiresAt=$passwordResetTokenExpiresAt, lastName=$lastName, phoneNumber=$phoneNumber, email=$email, jwtTokenInvalidBefore=$jwtTokenInvalidBefore, importHash=$importHash, avatars=$avatars, id=$id, createdAt=$createdAt, updatedAt=$updatedAt, deletedAt=$deletedAt, createdById=$createdById, updatedById=$updatedById]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (jwtTokenInvalidBefore != null) {
      json[r'jwtTokenInvalidBefore'] = jwtTokenInvalidBefore.toUtc().toIso8601String();
    }
    if (importHash != null) {
  ...
  /// Returns a new [UserRelated] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UserRelated fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UserRelated(
        ...
        jwtTokenInvalidBefore: mapDateTime(json, r'jwtTokenInvalidBefore', ''),
  ...
  static List<UserRelated> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(UserRelated.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <UserRelated>[];

  static Map<String, UserRelated> mapFromJson(dynamic json) {
    final map = <String, UserRelated>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = UserRelated.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of UserRelated-objects as value to a dart map
  static Map<String, List<UserRelated>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<UserRelated>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = UserRelated.listFromJson(
            value,
