...
class MedicalHistoryRepository {
  ...
  static async create(data, options: IRepositoryOptions) {
    ...
    const record = await options.database.medicalHistory.create(
      {
        ...lodash.pick(data, [
          'smoking',
          'drugUse',
  ...
  static async update(id, data, options: IRepositoryOptions) {
    ...
    let record = await options.database.medicalHistory.findOne(      
      {
        where: {
          id,
  ...
  static async findById(id, options: IRepositoryOptions) {
    ...
    const record = await options.database.medicalHistory.findOne(
      {
        where: {
          id,
          tenantId: currentTenant.id,
  ...
  static async filterIdsInTenant(
    ...
    const records = await options.database.medicalHistory.findAll(
      {
        attributes: ['id'],
        where,
      },
  ...
  static async count(filter, options: IRepositoryOptions) {
    ...
    return options.database.medicalHistory.count(
      {
        where: {
          ...filter,
          tenantId: tenant.id,
  ...
  static async findAndCountAll(
    ...
    let {
      rows,
      count,
    } = await options.database.medicalHistory.findAndCountAll({
      where,
      include,
